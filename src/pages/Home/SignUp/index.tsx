  ...
  return (
    <DialogWrapper title={getTitle()} handleClose={handleClose} open={open}>
      <DialogContent>
          ...
          {stage === 2 && (
            <div className="radio-container">
              ...
              <div className="d-flex align-items-center">
                <label
                  className={clsx("w-100 mx-1 border rounded px-2 py-4", {
                    isActive: details.plan === "plan1",
                  })}
                  htmlFor="plan1"
                >
                  <input
        ...
        <DialogActions>
          {stage > 1 && stage <= 3 && (
            <Button type="button" onClick={handlePrevState}>Prev</Button>
          )}
          {stage < 3 && <Button type="button" onClick={handleNextState}>Next</Button>}
          {stage === 3 && (
